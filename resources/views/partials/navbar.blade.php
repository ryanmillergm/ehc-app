                ...
                <div class="relative">
                    ...
                    <select
                        ...
                        class="appearance-none rounded-full border border-slate-200 bg-white
                               px-3 py-1.5 pr-9 text-xs font-medium text-slate-700
        ...
        <div class="flex-1 overflow-y-auto px-6 py-4 space-y-6">
            ...
            <div class="pt-4 border-t border-slate-800/60 space-y-2">
                ...
                <div class="relative">
                    <select
                        wire:change="switchLanguage($event.target.value)"
                        class="w-full appearance-none rounded-full border border-slate-700 bg-slate-900
                               px-3 py-2 pr-9 text-xs font-medium text-slate-100
                               hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-indigo-400"
                    >
                        @foreach ($languages as $lang)
                            <option
                                value="{{ $lang->locale }}"
