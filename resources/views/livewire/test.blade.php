...
<section class="hidden md:block bg-slate-950 text-white border-y border-white/10">
    ...
    <section id="give" class="scroll-mt-20 py-16 sm:py-20">
        <div class="mx-auto max-w-screen-2xl px-6 sm:px-8 lg:px-12 2xl:px-20">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start lg:items-stretch">
                ...
                <div class="lg:col-span-6 space-y-6">
                    ...
                    <div class="relative h-[600] sm:h-[400px] overflow-hidden rounded-3xl text-white p-6 sm:p-8">
                        {{-- Background image --}}
                        <div
                            class="absolute inset-0 bg-cover bg-center"
        ...
        <div class="mx-auto max-w-screen-2xl px-6 sm:px-8 lg:px-12 2xl:px-20 py-14 sm:py-16">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
                ...
                <div class="md:col-span-4 flex md:justify-end">
                    <a href="#give-form"
                       class="inline-flex items-center justify-center rounded-full bg-white px-7 py-3.5
                              text-sm font-semibold text-slate-900 shadow-sm hover:bg-slate-100 transition">
                        Give now
                    </a>
                </div>
            </div>
        ...
        <div class="mx-auto max-w-screen-2xl px-6 sm:px-8 lg:px-12 2xl:px-20 py-12">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                ...
                <div class="lg:col-span-6 space-y-4">
                    <h3 class="text-2xl font-extrabold">Bread of Grace Ministries</h3>
                    <p class="text-white/70 max-w-xl">
                        Christ-centered street ministry serving the homeless and at-risk community with the Word of God and practical support.
                    </p>
                    <div class="flex items-center gap-4">
                        {{-- Replace href="#" with real links --}}
                        <a href="#" class="opacity-80 hover:opacity-100 transition" aria-label="Facebook">
                            <img src="{{ asset('images/icon-facebook.svg') }}" alt="" class="h-7 w-7">
                        </a>
                        <a href="#" class="opacity-80 hover:opacity-100 transition" aria-label="YouTube">
                            <img src="{{ asset('images/icon-youtube.svg') }}" alt="" class="h-7 w-7">
                        </a>
                        <a href="#" class="opacity-80 hover:opacity-100 transition" aria-label="Instagram">
                            <img src="{{ asset('images/icon-instagram.svg') }}" alt="" class="h-7 w-7">
                        </a>
                    </div>
                </div>
                ...
                <div class="lg:col-span-3">
                    <div class="flex flex-col gap-3 text-base font-semibold">
                        ...
                        <a href="#serve" class="hover:text-rose-300 transition">Serve</a>
                        <a href="#give-form" class="hover:text-rose-300 transition">Give</a>
                        <a href="#visit" class="hover:text-rose-300 transition">Visit</a>
                    </div>
                </div>

                <div class="lg:col-span-3">
                    <div class="rounded-2xl bg-white/5 ring-1 ring-white/10 p-5">
                        <p class="text-sm font-semibold">Stay connected</p>
                        <form action="#" class="mt-3 space-y-3">
                            <input
                                type="email"
                            ...
                            />
                            <button
                                class="w-full rounded-full bg-rose-600 px-6 py-2 font-semibold
    ...
    @once
        <script>
            document.addEventListener('click', function (e) {
                ...
                const offset = (header?.offsetHeight ?? 0); // +12px breathing room
