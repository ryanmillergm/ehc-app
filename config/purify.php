    ...
    */
    ...
    'configs' => [
        ...
        'cms_custom_html_strict' => [
            ...
            'HTML.Allowed' => implode(',', [
                'h1[class]','h2[class]','h3[class]','h4[class]','h5[class]','h6[class]',
                'p[class]','span[class]','br','hr',
                'strong[class]','b[class]','em[class]','i[class]','u[class]','s[class]',
                'a[href|title|target|rel|class]',
                'ul[class]','ol[class]','li[class]',
                'div[class]','section[class]','article[class]',
                'img[src|alt|title|width|height|class]',
                'figure[class]','figcaption[class]',
                'blockquote[class]',
            ]),
        ...
        'cms_custom_html_trusted' => [
            ...
            'HTML.Allowed' => implode(',', [
                ...
                'p[class|id]','span[class|id]','br','hr',
                'strong[class]','b[class]','em[class]','i[class]','u[class]','s[class]',
                'a[href|title|target|rel|class|id]',
                'ul[class|id]','ol[class|id]','li[class|id]',
                'div[class|id]','section[class|id]','article[class|id]',
                'img[src|alt|title|width|height|class]',
                'figure[class|id]','figcaption[class|id]',
                'blockquote[class|id]','code[class]','pre[class]',
                'table[class]','thead','tbody','tfoot','tr','th','td',
                'video[src|poster|preload|controls|width|height|class]',
                'source[src|type]',
                'iframe[src|width|height|title|frameborder|class]',
